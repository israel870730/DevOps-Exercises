...
variable "admin_sso_role_arn" {
  type        = string
  description = "ARN of Account Administrator AWS SSO Role with specific syntax for example: It should exclude words aws-reserved/sso.amazonaws.com/<region>, It should be like this arn:aws:iam::<account number>:role/AWSReservedSSO_AWSAdministratorAccess_7777777777777"
}