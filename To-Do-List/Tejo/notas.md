...
2. Habilitar el alojamiento de sitio web estático
  En la consola de S3, ve a tu bucket → Properties → Static website hosting → Enable. Configura el documento de índice (index.html) y opcionalmente un documento de error (error.html). 
  Con la CLI:
